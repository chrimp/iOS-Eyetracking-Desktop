...
///
public class EyeTracking: NSObject, ObservableObject {
    ...
    public var collectedGazePoints: [CGPoint] = []
    public var calibrationPoints: [CGPoint] = []
    public var calibratedCoefficients: ([CGFloat]?, [CGFloat]?)
    public var transformBlend: CGFloat = 0.9
    public var averageBlend: CGFloat = 0.9
...
//            pointerFilter = (
//                LowPassFilter(value: point.x, filterValue: 0.85),
//                LowPassFilter(value: point.y, filterValue: 0.85)
//            )
//        } else {
//            pointerFilter?.x.update(with: point.x)
//            pointerFilter?.y.update(with: point.y)
//        }
        
        //let pointMA = movingAverage.update(with: point, blend: averageBlend)
